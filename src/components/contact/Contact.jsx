...
function Contact() {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm('service_1u5cx76', 'template_lyzuqfq', formref.current, {
                publicKey: 'WWkPk92W8j4_lhFH1',
            })
            .then(
                () => {
                    console.log('SUCCESS!');
    ...
    return (
        <motion.div
            ...
            <motion.div className="textContainer">
                ...
                <motion.div variants={variants} className="item">
                    <h2>Phone</h2>
                    <span>+91 9593618969</span>
                </motion.div>
            </motion.div>
            <div className="formContainer">
                <motion.div className="phoneSvg"
                    initial={{ opacity: 1 }}
                    whileInView={{ opacity: 0, visibility: 0 }}
