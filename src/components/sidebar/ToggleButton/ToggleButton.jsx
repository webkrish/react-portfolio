...
function ToggleButton({setOpen}) {
  return  <button onClick={()=> setOpen((prev) =>! prev)}>
    <svg width='23' height='23'viewBox='0 0 23 23'>
      ...
      <motion.path strokeWidth="3" stroke='black' strokeLinecap='round' d="M 2 11.5 L 20 11.5" opacity={1} variants={{
        closed:{opacity:1},
        open:{opacity:0}
      }}/>
      <motion.path strokeWidth="3" stroke='black' strokeLinecap='round' opacity={1} variants={{
